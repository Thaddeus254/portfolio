        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-center">
                ...
                <a href="mailto:shetrahgrafix@gmail.com" 
                   className="text-gray-300 transition-colors hover:scale-105 transform"
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex justify-center md:justify-end space-x-4 mb-4">
              <a href="https://github.com/Shetrah/" 
                 className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center transition-all duration-300 hover:scale-110"
                 style={{ '--hover-bg': 'linear-gradient(135deg, #4169E1 0%, #FF0000 100%)' }}
              ...
              <a href="https://www.facebook.com/shetrahgrafix/" 
                 className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center transition-all duration-300 hover:scale-110"
                 onMouseEnter={(e) => e.target.style.background = 'linear-gradient(135deg, #4169E1 0%, #FF0000 100%)'}
                 onMouseLeave={(e) => e.target.style.background = ''}>
              ...
              <a href="https://x.com/shennel_oduor?t=Bu-wFiUNzLIYgddSDJt4qA&s=08/" 
                 className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center transition-all duration-300 hover:scale-110"
                 onMouseEnter={(e) => e.target.style.background = 'linear-gradient(135deg, #4169E1 0%, #FF0000 100%)'}
                 onMouseLeave={(e) => e.target.style.background = ''}>
              ...
              <a href="https://wa.me/message/SCQ7POKM6TQ5N1/" 
                 className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center transition-all duration-300 hover:scale-110"
                 onMouseEnter={(e) => e.target.style.background = 'linear-gradient(135deg, #4169E1 0%, #FF0000 100%)'}
                 onMouseLeave={(e) => e.target.style.background = ''}>
